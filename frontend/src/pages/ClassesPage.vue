  ...
  <q-page padding>
    ...
    <q-dialog v-model="groupsDialog" full-width>
      <q-card style="max-width:860px;width:100%">
        ...
        <q-card-section>
          <!-- Concept explanation -->
          <q-banner dense rounded class="bg-teal-1 text-teal-10 q-mb-md" style="font-size:12px">
            <template #avatar><q-icon name="call_split" color="teal-7" /></template>
            <div class="text-weight-bold q-mb-xs">O que são Turnos?</div>
            <div class="q-mb-sm">
              A turma divide-se em dois grupos que têm <strong>disciplinas diferentes ao mesmo tempo</strong>, em salas e com professores diferentes.
              Cada grupo tem a sua própria estrutura semanal (quantas aulas por semana, em bloco ou separadas).
            </div>
            <div class="q-mb-xs text-weight-medium">Exemplo — 5.º A, 2 turnos de laboratório:</div>
            <div class="row q-col-gutter-sm q-mb-sm">
              <div class="col-12 col-sm-6">
                <div class="bg-white rounded-borders q-pa-sm" style="border:1px solid #b2dfdb">
                  <div class="text-caption text-weight-bold text-teal-8 q-mb-xs">Turno CN / FQ</div>
                  <div class="text-caption">1.ª metade → <strong>CN</strong>, Lab A, Prof. Silva — bloco duplo 2.ª feira</div>
                  <div class="text-caption">2.ª metade → <strong>FQ</strong>, Lab B, Prof. Costa — bloco duplo 2.ª feira</div>
                  <div class="text-caption text-teal-7 q-mt-xs">↑ acontecem ao mesmo tempo</div>
                </div>
              </div>
              <div class="col-12 col-sm-6">
                <div class="bg-white rounded-borders q-pa-sm" style="border:1px solid #b2dfdb">
                  <div class="text-caption text-weight-bold text-teal-8 q-mb-xs">Na semana seguinte rodam</div>
                  <div class="text-caption">1.ª metade → <strong>FQ</strong>, Lab B, Prof. Costa</div>
                  <div class="text-caption">2.ª metade → <strong>CN</strong>, Lab A, Prof. Silva</div>
                  <div class="text-caption text-grey-6 q-mt-xs">(a rotação é gerida pelo gerador de horários)</div>
                </div>
              </div>
            </div>
            <div class="text-grey-7">
              <q-icon name="info" size="xs" class="q-mr-xs" />A <strong>estrutura semanal</strong> de cada disciplina (bloco, separado, etc.) define-se nos <strong>Planos Curriculares</strong>. Aqui apenas se indica quais as duas disciplinas que partilham o mesmo bloco horário para grupos diferentes.
            </div>
          </q-banner>
